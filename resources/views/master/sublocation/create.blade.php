...
<section class="locations-section py-4">
    <div class="container container-custom">
        <div class="content-card card card-body mb-3">
            <form action="{{ route('master.sublocation.store') }}" method="post" name="location_form">
                @csrf
                <div class="page-header pb-0">
                    <h4 class="fs22">Add New Sublocation</h4>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="sublocationName" placeholder="Enter sublocation name" name="name" value="{{old('name')}}">
                        @error('name')
                ...
                <div class="mb-3">
                    ...
                    placeholder="Describe the sublocation">{{ old('description') }}</textarea>
                    @error('description')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
