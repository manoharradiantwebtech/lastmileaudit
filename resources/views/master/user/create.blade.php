    ...
    <div class="container container-custom">
        <div class="content-card card card-body mb-3">
            <form action="{{ route('master.user.store') }}" method="post" name="user_form">
                @csrf
                <div class="page-header pb-0"> <h4 class="fs22">Add New User</h4> </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <input type="tel" value="{{old('phone')}}" class="form-control" name="phone" id="mobile" placeholder="Enter your mobile number">
                        @error('phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="text-end"><button type="submit" class="btn btn-prime btn-lg px-5">CREATE TEAM</button></div>
            </form>
        </div>
    </div>
</section>
